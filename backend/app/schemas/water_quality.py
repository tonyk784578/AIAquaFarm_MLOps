...
class WaterQualityBase(BaseModel):
    ...
    temperature_c: Optional[float] = Field(None, ge=-5.0, le=50.0)
    ph: Optional[float] = Field(None, ge=0.0, le=14.0)
    dissolved_oxygen_mgl: Optional[float] = Field(None, ge=0.0, le=30.0)
    turbidity_ntu: Optional[float] = Field(None, ge=0.0)
    salinity_ppt: Optional[float] = Field(None, ge=0.0, le=50.0)
    ammonia_ppm: Optional[float] = Field(None, ge=0.0)
    nitrite_ppm: Optional[float] = Field(None, ge=0.0)
...
class WaterQualityCreate(WaterQualityBase):
    ...
    ammonia_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
    nitrite_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
...
class WaterQualityRead(WaterQualityBase):
    ...
    measured_at: datetime
    source: str
    ammonia_confidence: Optional[float] = None
    nitrite_confidence: Optional[float] = None
